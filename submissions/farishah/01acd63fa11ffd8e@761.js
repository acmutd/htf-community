export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["acmcube.png",new URL("./files/27ce7f29091bdb06db2c41c8b5abeb6418a12703697ece123214d3bd5a0dbc5181867ece3aa5e959802d5b1e7494e575ef374f9d3e90dab31a0088c459794cbd",import.meta.url)]]);
...
loadTexture(gl, await FileAttachment('acmcube.png').image())
)});
  main.variable(observer()).define(["md"], function(md){return(
md`
